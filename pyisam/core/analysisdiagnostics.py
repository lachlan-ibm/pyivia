...
class AnalysisDiagnostics9020(object):
    '''
    Object is used to manage and collect log files from Verify Access runtime applications

    application_logs: retrieve log files generated by verify access runtime applications
    '''
