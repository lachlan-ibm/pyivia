...
are versioned and should be created using the provided factory. The factory uses a well known API to discover the release 
version and deployment model being used.
