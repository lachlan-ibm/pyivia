...
class SystemSettings9020(object):
    ...
    :var dns: Update the DNS settigns used by Verify Identity Access
    :var file_downloads: Fetch files hosted by Verify Identity Access
    :var first_steps: Complete the fisrt steps of Verify Identity Access configuration and accept the EULA
    :var hosts_file: Modify the host file used by Verify Identity Access (Applaince only)
    :var interfaces: Manage the networking interfaces used by Verify Identity Access (Applaicne only)
    :var static_routes: Manage the networking gateway settings used by Verify Identity Access
    :var fixpacks: Upload and apply FixPacks generated by support
    :var licensing: Apply license codes to activate Verify Identity Access modules
    :var restartshutdown: Manage the state of Verify Identity Access appliance
    :var ssl_certificates: Craete and manage the SSL databases used by Verify Identity Access components
