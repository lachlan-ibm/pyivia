...
class SystemSettings(object):
    ...
    :var static_routes: Manage the networking :ref:`gateway settings<Static Routes>` used by Verify Access.
    ...
    :var restartshutdown: Manage the state of Verify Access :ref:`appliance <Restart and Shutdown>`.
