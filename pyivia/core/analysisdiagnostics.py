...
class AnalysisDiagnostics(object):
    '''
<<<<<<<< HEAD:pyisva/core/analysisdiagnostics.py
    Object is used to manage and collect log files from Verify Identity Access runtime applications
...
>>>>>>>> development:pyivia/core/analysisdiagnostics.py
    '''
