...
- Search for both [**open** and **closed** issues](https://github.ibm.com/ibm-security/pyivia/issues?utf8=%E2%9C%93&q=is%3Aissue) as the problem may have already been reported. If it has and is open, add a comment to the existing issue instead of opening a new one.
...
- Search for both [**open** and **closed** issues](https://github.ibm.com/ibm-security/pyivia/issues?utf8=%E2%9C%93&q=is%3Aissue) as the enhancement may have already been suggested. If it has and is open, add a comment to the existing issue instead of opening a new one.
...
1. Identify an issue you would like to contribute code to. This can be achieved by:
    1. searching for [open issues](https://github.ibm.com/ibm-security/pyivia/issues), or
